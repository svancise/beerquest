#Old Ox's Hardway Summer Lager and Modelo Especial
...
def create_index_html(data):
    ...
    for key in data["typeKeys"]:
        ...
        os.makedirs("website/" + key[0])

        fileName = "website/" + key[0] + "/index.html"
        ...
        for section in soup.find_all('ul', class_="menu-section-list"):
            for beer in section.find_all('li'):
                ...
                beer = {
                    ...
                    # 'rating' : infoData.find('h6').find('span', class_='rating')['class'][2],
